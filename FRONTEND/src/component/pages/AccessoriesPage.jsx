...
//   return (
//     <div className="max-w-7xl mx-auto px-4 py-10 font-sans relative">
//       <ToastContainer />
...
// const AccessoryCard = ({ item, onView, onAddToCart }) => (
...
// const AccessoryModal = ({ accessory, onClose, onAddToCart }) => {
